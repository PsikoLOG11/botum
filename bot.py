...
BOT_TOKEN = "7872125666:AAF24biRsKOvrjXvUTIDbhd2GXCMLVyTNkU"

required_group = {"name": "CHAT GRUBUMUZA KATIL", "chat_id": -1001863508450, "link": "https://t.me/chatdarktr"}
required_channel = {"name": "KANALIMIZA KATIL", "chat_id": -1002013658665, "link": "https://t.me/anticheckerz"}
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if not is_member_group or not is_member_channel:
        ...
        with open("welcome_image.jpg", "rb") as image:
...
async def adsoyad(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    url = f"https://api.tsgmods.com.tr/tsgfreeapi/adpro.php?auth=tsgxyunus&ad={ad}&soyad={soyad}"
    try:
    ...
    if api_data.get("success") and "data" in api_data:
        ...
        file_name = f"AntiChecker_{random_number}.txt"

         
        with open(file_name, "w") as file:
            for person_data in api_data["data"]:
                file.write("----- Anti Checker -----\n")
...
async def adsoyadil(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    url = f"https://api.tsgmods.com.tr/tsgfreeapi/adpro.php?auth=tsgxyunus&ad={ad}&soyad={soyad}&il={il}"
    try:
        response = requests.get(url)
        response.raise_for_status()
        api_data = response.json()
...
async def tcpro(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    url = f"https://api.tsgmods.com.tr/tsgfreeapi/adpro.php?auth=tsgxyunus&tc={tc}"
    try:
        response = requests.get(url)
        response.raise_for_status()
        api_data = response.json()   
...
async def aile(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    url = f"https://api.tsgmods.com.tr/tsgfreeapi/aile.php?tc={tc}"
    try:
        response = requests.get(url)
        response.raise_for_status()
        api_data = response.json()
...
async def sulale(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    url = f"https://api.tsgmods.com.tr/tsgfreeapi/sulale.php?tc={tc}"
    try:
        response = requests.get(url)
        response.raise_for_status()
        api_data = response.json()
...
async def adres(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    url = f"https://api.tsgmods.com.tr/tsgfreeapi/adres.php?tc={tc}"
    try:
        response = requests.get(url)
        response.raise_for_status()
        api_data = response.json()
...
async def apartman(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    url = f"https://api.tsgmods.com.tr/tsgfreeapi/apartman.php?tc={tc}"
    try:
        response = requests.get(url)
        response.raise_for_status()
        api_data = response.json()
    ...
    if api_data.get("success") and "data" in api_data:
        ...
        file_path = "AntiChecker_Apartman.txt"
...
async def gsmtc(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    url = f"https://api.tsgmods.com.tr/tsgfreeapi/gsmtc.php?gsm={gsm}"
    try:
        response = requests.get(url)
        response.raise_for_status()
        api_data = response.json()
...
async def tcgsm(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    url = f"https://api.tsgmods.com.tr/tsgfreeapi/tcgsm.php?tc={tc}"
    try:
        response = requests.get(url)
        response.raise_for_status()
        api_data = response.json()
